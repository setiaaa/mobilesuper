            ...
            <View style={{
                ...
                <TouchableOpacity onPress={onclick}>
                    ...
                    <View style={{ marginVertical: 20, marginHorizontal: 5 }}>
                        <Text style={{ color: COLORS.grey, marginVertical: 5, fontSize: 10, fontWeight: 400, textAlign: 'center' }}>{deskripsi}</Text>
                    </View>
                </TouchableOpacity>
            </View>
        </View>
        ...
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <View style={{ backgroundColor: '#f7f7f7', flex: 1 }}>
                <View style={{ backgroundColor: COLORS.primary, height: '10%', flexDirection: 'row' }}>
                    ...
                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', marginRight: 40 }}>
                        <Text style={{ color: 'white', fontSize: 15, fontWeight: 600 }}>Galeri</Text>
                    </View>
                </View>
            ...
            >
                ...
                <View style={{ alignItems: 'center', flex: 1, display: 'flex', justifyContent: 'center' }}>
                    ...
                    <View >
                        <Image source={galeriById.image} style={{ width: 390, height: 283 }} />
                    </View>
                </View>
            </Modal>
        </SafeAreaView>
