...
export const FileOutgoingDetail = ({ navigation }) => {
  ...
  return (
    <View style={{ padding: 20 }}>
        ...
        <View style={{ backgroundColor: COLORS.white, borderRadius: 16, padding: 20, gap: 20 }}>
            <View style={{ gap: 10 }}>
            ...
            <View style={{ gap: 20, marginBottom: 10 }}>
                <Text style={{ fontSize: 13, fontWeight: 600 }}>Ganti File Surat</Text>
                <View style={{ gap: 10 }}>
                    <View style={{ width: 100, height: 100, borderWidth: 1, borderColor: "#DBDADE", justifyContent: "center", alignItems: "center", alignSelf: "center", borderRadius: 6 }}>
                        <Image source={require("../../../../assets/superApp/pdf.png")} />
                    </View>
                    <Text style={{ fontSize: 13, fontWeight: 400, color: COLORS.lighter, textAlign: "center" }}>Nama File</Text>
                    <Text style={{ fontSize: 13, fontWeight: 400, color: COLORS.lighter, textAlign: "center" }}>Nama File.pdf</Text>
                    <TouchableOpacity onPress={() => navigation.navigate("DetailSuratUnggahan")}
                        style={{ 
                            backgroundColor: COLORS.infoDanger,
                            height: 50, 
                            width: 100,
                        ...
                        <Ionicons name="eye-outline" size={15} color={COLORS.white} />
                        <Text style={{ fontSize: 13, fontWeight: 500, color: COLORS.white }}>Lihat</Text>
                    </TouchableOpacity>
                </View>
            </View>
            <View style={{ gap: 20, marginBottom: 10 }}>
                <Text style={{ fontSize: 13, fontWeight: 600 }}>Ganti File Surat</Text>
                <Text style={{ fontSize: 13, fontWeight: 400, color: COLORS.lighter, textAlign: "center" }}>Tidak ada file yang diunggah</Text>
            </View>
        </View>
        </ScrollView>
    </View>
