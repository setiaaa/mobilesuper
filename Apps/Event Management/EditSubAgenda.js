...
export const EditSubAgenda = () => {
    ...
    const [pilihanPesertaTambahanInternal, setPilihanPesertaTambahanInternal] = useState([])
    ...
    useEffect(() => {
        ...
        pic.push({
            key: event.detailEvent?.extra_attrs.pic.is_employee ? event.detailEvent?.extra_attrs.pic.nip : event.detailEvent?.extra_attrs.pic.title.objid,
            value: event.detailEvent?.extra_attrs.pic.is_employee ? event.detailEvent?.extra_attrs.pic.nama : event.detailEvent?.extra_attrs.pic.title.name
        })
        setJudul(agendaDetail.title)
        setKategori({
            key: agendaDetail.extra_attrs?.pic.is_employee ? agendaDetail.extra_attrs?.pic.nip : agendaDetail.extra_attrs?.pic.title.objid,
            value: agendaDetail.extra_attrs?.pic.is_employee ? agendaDetail.extra_attrs?.pic.nama : agendaDetail.extra_attrs?.pic.title.name
        })
                        ...
                        <Pressable onPress={() => richText.current?.dismissKeyboard()}>
                            <View style={{ flexDirection: 'row', alignItems: 'flex-end', backgroundColor: COLORS.primary, height: 80, paddingBottom: 20 }}>
                                ...
                                <View style={{ flex: 1, alignItems: 'center', marginRight: 50 }}>
                                    <Text style={{ fontSize: 15, fontWeight: 600, color: COLORS.white }}>Edit Sub Agenda</Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.Card}>
                                ...
                                <View style={{ marginTop: 20, marginBottom: 10, marginLeft: 17, flexDirection: 'row' }}>
                                    <Text style={{ fontWeight: FONTWEIGHT.bold, fontSize: FONTSIZE.H3 }}>Judul Sub Agenda</Text>
                                ...
                                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: 17 }}>
                                    <View>
                                        ...
                                        >
                                            ...
                                            />
                                            <View style={{ alignItems: 'flex-end', flex: 1, marginRight: 10, justifyContent: 'center' }}>
                                                <TouchableOpacity onPress={() => setModalVisibleTimePicker('mulai')}>
                                    ...
                                    <View>
                                        ...
                                        >
                                            ...
                                            />
                                            <View style={{ alignItems: 'flex-end', flex: 1, marginRight: 10, justifyContent: 'center' }}>
                                                <TouchableOpacity onPress={() => setModalVisibleTimePicker('selesai')}>
                                                    <Ionicons name='time-outline' size={24} color={COLORS.grey} />
                                                </TouchableOpacity>
                                            </View>
                                        </View>
                                ...
                                <Modal
                                    animationType="fade"
                                    transparent={true}
                                    visible={modalVisibleTimePicker === 'mulai' || modalVisibleTimePicker === 'selesai' ? true : false}
                                    onRequestClose={() => {
                                ...
                                >
                                    ...
                                    <View style={{ justifyContent: 'center', alignItems: 'center', flex: 1 }}>
                                        <View style={{ backgroundColor: COLORS.white, alignItems: 'center', justifyContent: 'center', width: '90%', height: 500, borderRadius: 10 }}>
                                            <TouchableOpacity onPress={() => setModalVisibleTimePicker('')} style={{ paddingRight: '85%', marginBottom: 3, marginLeft: 20 }}>
                                                ...
                                                <DatePicker
                                                    ...
                                                    onTimeChange={selectedTime => {
                                                        if (modalVisibleTimePicker === 'mulai') {
                                                            ...
                                                            if (waktuMulai && waktuMulai < selectedTime) setWaktuSelesai(selectedTime)
                                                            else if (waktuMulai && waktuMulai > selectedTime) alert('waktu selesai kurang dari waktu mulai')
                                                        }
                                                        setModalVisibleTimePicker('')
                                                    }}
                                                />
                                        ...
                                        <View style={{ backgroundColor: COLORS.white, alignItems: 'center', justifyContent: 'center', width: '90%', height: 500, borderRadius: 10 }}>
                                            ...
                                            <View style={{ width: '100%' }}>
                                                <DatePicker
                                                    ...
                                                    minimumDate={event.detailEvent?.start_date.split('T')[0]}
                                                    maximumDate={event.detailEvent?.end_date.split('T')[0]}
                                ...
                                <View style={{ marginTop: 10, marginBottom: 10, marginLeft: 17, flexDirection: 'row' }}>
                                    <Text style={{ fontWeight: FONTWEIGHT.bold, fontSize: FONTSIZE.H3 }}>Pilih dan lihat Peserta</Text>
                                    <Text style={{ color: COLORS.danger }}>*</Text>
                                </View>
                                <View style={{
                                    borderWidth: 1,
                                    ...
                                    <View style={{ justifyContent: 'center', alignItems: 'center', flex: 1 }}>
                                        <View style={{ backgroundColor: COLORS.white, width: '90%', height: '70%', borderRadius: 8, padding: 20 }}>
                                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                                                ...
                                                <Text style={{ fontWeight: FONTWEIGHT.bold }}>Peserta Sub Agenda</Text>
                                            </View>
                                            {/* custom divider */}
                                            ...
                                            <View>
                                                <View style={{ marginVertical: 20 }}>
                                                    <Search onSearch={(e) => {
                                                        const data = event.detailEvent?.extra_attrs.members.filter(item => item.nama.toLowerCase().includes(e.toLowerCase()))
                                                        if (e !== '' || data.length > 0) {
                                                            setPilihanPeserta(data)
                                                        } else {
                                                            setPilihanPeserta(event.detailEvent?.extra_attrs.members)
                                ...
                                <View style={{ marginTop: 10, marginBottom: 10, marginLeft: 17, flexDirection: 'row' }}>
                                    <Text style={{ fontWeight: FONTWEIGHT.bold, fontSize: FONTSIZE.H3 }}>Peserta Tambahan Internal</Text>
                                    <Text style={{ color: COLORS.danger }}>*</Text>
                                </View>
                                <View style={{
                                    borderWidth: 1,
                                ...
                                <View style={{ marginTop: 10, marginBottom: 10, marginHorizontal: 17, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                    <Text style={{ fontWeight: FONTWEIGHT.bold, fontSize: FONTSIZE.H3 }}>Pilih dan Lihat Tamu Eksternal</Text>
