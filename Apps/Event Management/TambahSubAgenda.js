...
import { getEventProgress, getEventToday, getlistKalender, postAttachment, postEvent, postSubAgenda } from '../../service/api';
...
export const TambahSubAgenda = () => {
    ...
    const { attachment, status, event, loading } = useSelector(state => state.event)
                        ...
                        <Pressable onPress={() => richText.current?.dismissKeyboard()}>
                            <View style={{ flexDirection: 'row', alignItems: 'flex-end', backgroundColor: COLORS.primary, height: 80, paddingBottom: 20 }}>
                                ...
                                <View style={{ flex: 1, alignItems: 'center', marginRight: 50 }}>
                                    <Text style={{ fontSize: 15, fontWeight: 600, color: COLORS.white }}>Tambah Sub Agenda</Text>
                                </View>
                            </View>
