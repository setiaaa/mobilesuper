...
export const EditAgendaGrup = ({ route }) => {
    ...
    useEffect(() => {
        ...
        setTanggalMulai(moment(editAgenda.start_date,).format(DATETIME.LONG_DATETIME))
        setTanggalSelsai(moment(editAgenda.end_date).format(DATETIME.LONG_DATETIME))
        setPicAcara({
    ...
    const handleSubmit = () => {
        ...
        const payload = {
            ...
            start_date: moment(TanggalMulai, 'DD MMMM YYYY HH:mm:ss').format('YYYY-MM-DD HH:mm:ss'),
            end_date: moment(TanggalSelesai, 'DD MMMM YYYY HH:mm:ss').format('YYYY-MM-DD HH:mm:ss'),
            dresscode: ketentuan,
            location: lokasi,
            catatan: catatan
        }
                        ...
                        <Pressable>
                            <View style={{ flexDirection: 'row', alignItems: 'flex-end', backgroundColor: COLORS.primary, height: 80, paddingBottom: 20 }}>
                                ...
                                <View style={{ flex: 1, alignItems: 'center', marginRight: 50 }}>
                                    <Text style={{ fontSize: 15, fontWeight: 600, color: COLORS.white }}>Edit Agenda Acara</Text>
                                </View>
                            </View>
                                                ...
                                                <DatePicker
                                                    ...
                                                    onSelectedChange={date => {
                                                        ...
                                                        if (modalVisiblePicker === 'mulai') {
                                                            setTanggalMulai(moment(date, 'YYYY/MM/DD HH:mm').format(DATETIME.LONG_DATETIME))
                                                        } else if (modalVisiblePicker === 'selesai') {
                                                            setTanggalSelsai(moment(date, 'YYYY/MM/DD HH:mm').format(DATETIME.LONG_DATETIME))
                                                        }
