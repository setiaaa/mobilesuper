                                ...
                                <View>
                                    <View style={{ marginHorizontal: 20, marginTop: 20, flexDirection: 'row' }}>
                                        ...
                                        {loading ? (
                                            ...
                                            <View style={{ justifyContent: 'center' }}>
                                                <Text style={{ width: 150 }}>{detailGrup?.extra_attributes?.perlengkapan == null ? '-' : detailGrup?.extra_attributes?.perlengkapan}</Text>
                                            </View>
                                        )}
                                    </View>
                                    <View style={{ height: 1, width: '90%', backgroundColor: COLORS.lighter, opacity: 0.3, marginTop: 10, marginHorizontal: 20 }} />
                                            ...
                                            detailGrup.members?.length < 3 ? (
                                                ...
                                                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', flex: 1 }}>
                                                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
                                                        <Image source={{ uri: detailGrup.members[0]?.avatar_url }} style={{
                                                            marginLeft: -8,
                                                            borderWidth: 2,
                                                            borderRadius: 50,
                                                            borderColor: COLORS.white,
                                                        ...
                                                        <Image source={{ uri: detailGrup.members[1]?.avatar_url }} style={{
                                                            marginLeft: -8,
                                                            borderWidth: 2,
                                                            borderRadius: 50,
                                                            borderColor: COLORS.white,
                                                        ...
                                                        <Image source={{ uri: detailGrup.members[2]?.avatar_url }} style={{
                                                            marginLeft: -8,
                                                            borderWidth: 2,
                                                            borderRadius: 50,
                                                            borderColor: COLORS.white,
