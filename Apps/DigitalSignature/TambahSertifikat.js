...
import { addAttachmentDigiSign, addDocumentDigiSign, getCourseDigiSign, postAttachment } from '../../service/api'
        ...
        <SafeAreaView>
            <ScrollView>
                <Pressable onPress={() => richText.current?.dismissKeyboard()}>
                    ...
                    <View style={styles.Card}>
                        ...
                        <View style={{ marginTop: 10, marginBottom: 10, marginLeft: 17, flexDirection: 'row' }}>
                                ...
                                <View style={{ marginVertical: 10, marginHorizontal: 17 }}>
                                    <Text style={{ color: COLORS.lighter }}>*) Hanya pdf yang akan diterima dan ukuran file maks 10 MB</Text>
                                </View>

                        <View style={{ marginTop: 10, marginBottom: 10, marginLeft: 17, flexDirection: 'row' }}>
                            <Text style={{ fontWeight: FONTWEIGHT.bold, fontSize: FONTSIZE.H3 }}
                    ...
                    <TouchableOpacity style={{ marginVertical: 30, backgroundColor:"#D2B48C", padding: 20, borderRadius: 10, width: 180  }}  onPress={()=> {handleSubmitDraft()}}>
                            <Text style={{textAlign: "center", color: 'white'}}>Simpan Draft</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={{ marginVertical: 30, backgroundColor:"#752A2B", padding: 20, borderRadius: 10, width: 180  }}  onPress={()=> {handleSubmitUnggah()}}>
