                        ...
                        <ScrollView>
                            ...
                            <View style={{ backgroundColor: COLORS.white, marginHorizontal: 20, marginVertical: 20, borderRadius: 8 }}>
                                <View style={{ marginHorizontal: 20, marginVertical: 20 }}>
                                    <Text style={{ fontSize: FONTSIZE.Judul, color: COLORS.lighter }}>{taskDetail[0].kegiatan}</Text>

                                    <View style={{ marginTop: 10 }}>
                                        <Text style={{ fontSize: FONTSIZE.H4, color: COLORS.lighter }}>{taskDetail[0].deskripsi}</Text>
                                    </View>

                                    <View style={{ marginTop: 10, flexDirection: 'row' }}>
                                        <Text style={{ fontSize: FONTSIZE.H4, color: COLORS.lighter }}>Due Date</Text>
                                        <Text style={{ fontSize: FONTSIZE.H4, color: COLORS.lighter, textAlign: 'center', flex: 1 }}>: {taskDetail[0].tanggal}</Text>
                                    </View>
                                    ...
                                    <View style={{ marginTop: 10, flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                                        ...
                                        <View style={{ justifyContent: 'center', alignItems: 'center', flex: 1, marginRight: 15, flexDirection: 'row' }}>
                                            ...
                                            <View style={{ backgroundColor: COLORS.infoDangerLight, borderRadius: 30 }}>
                                                <Text style={{ fontSize: FONTSIZE.H4, color: COLORS.primary, marginHorizontal: 8, marginVertical: 4 }}>{taskDetail[0].prioritas}</Text>
                                            </View>
                                        </View>
                                    </View>
                                    ...
                                    <View style={{ marginTop: 10, flexDirection: 'row', alignItems: 'center' }}>
                                        ...
                                        <View style={{ flex: 1, alignItems: 'center', flexDirection: 'row', gap: 10, justifyContent: 'center', marginLeft: 45 }}>
                                            ...
                                            <View style={{ flexDirection: 'row', position: 'relative', display: 'flex', alignItems: 'center' }}>
                                                {taskDetail[0].subAvatar?.map((data) => {
                                                    return (
                                                        <View key={data.id}>
                                        ...
                                        <BottomSheetView onLayout={handleContentLayout} style={{}}>
                                            <View>
                                                ...
                                                <View style={{
                                                    ...
                                                    {taskDetail[0].Komentar?.map((listData) => (
                                                        <View key={listData.id} style={{ backgroundColor: COLORS.white, borderRadius: 10, width: '90%', marginVertical: 5 }}>
