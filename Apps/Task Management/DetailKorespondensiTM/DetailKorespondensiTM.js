...
import { getDetailKorespondensiTM, postMarkKorespondensiTM} from '../../../service/api'
                        ...
                        <ScrollView>
                            {
                                loading ? (
                                    ...
                                    <View style={{ backgroundColor: COLORS.white, marginHorizontal: 20, marginBottom: 20, borderRadius: 8, marginTop:20 }}>
                                        <View style={{ marginHorizontal: 20, marginVertical: 20, display: 'flex', flexDirection: 'column', gap: 20 }}>
                                            <View style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                                                <Text style={{ fontSize: FONTSIZE.Judul, color: COLORS.lighter, fontWeight: FONTWEIGHT.bold }}>{taskDetail.subject}</Text>
                                            ...
                                            <View style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                                                ...
                                                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                                    ...
                                                    <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                                                        ...
                                                        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
                                                            ...
                                                            <View style={{ flex: 1 }}>
                                                                <Text style={{ fontWeight: FONTWEIGHT.bold, fontSize: FONTSIZE.H4, }}>{taskDetail.sender[0]?.title?.name !== '' ? taskDetail.sender[0]?.title?.name : taskDetail.sender[0]?.name}</Text>
                                                                {
                                                                    taskDetail.sender[0]?.name !== '' ? (
                                                                        <Text style={{ fontWeight: FONTWEIGHT.normal, fontSize: FONTSIZE.H4, }}> {taskDetail.sender[0]?.name}</Text>
                                                                    ) : null
                                                                }
                                                            </View>
                                                        </View>
                                                ...
                                                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                                    <Text style={{ fontSize: FONTSIZE.H4, color: COLORS.lighter, width: '40%' }}>Penerima Tugas</Text>
                                                    <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                                                        <Text style={{ fontSize: FONTSIZE.H4, color: COLORS.lighter }}>: </Text>
                                                        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
                                                            ...
                                                            <View style={{ flex: 1 }}>
                                                                <Text style={{ fontWeight: FONTWEIGHT.bold, fontSize: FONTSIZE.H4 }}>{taskDetail.receiver[0]?.title?.name !== '' ? taskDetail.receiver[0]?.title?.name : taskDetail.receiver[0]?.name}</Text>
                                                                {
                                                                    taskDetail.receiver[0]?.title?.name !== '' ? (
                                                                        <Text style={{ fontWeight: FONTWEIGHT.normal, fontSize: FONTSIZE.H4 }}> {taskDetail.receiver[0]?.name}</Text>
                                                                    ) : null
                                                                }
                                                            </View>
                                                        </View>
                                                ...
                                                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                                    <Text style={{ fontSize: FONTSIZE.H4, color: COLORS.lighter, width: '40%' }}>Selesai</Text>
                                                    <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                                                        <Text style={{ fontSize: FONTSIZE.H4, color: COLORS.lighter }}>: </Text>
                                                        <View style={{ backgroundColor: taskDetail.done === false ? COLORS.infoDangerLight : taskDetail.done === true ? COLORS.successLight : COLORS.infoLight, borderRadius: 30, padding: 4 }}>
                                                            {taskDetail.done === true ? 
                                                                <Text style={{ fontSize: FONTSIZE.H4, color: COLORS.success, textTransform: 'capitalize' }}>Selesai</Text>
                                                            : 
                                                            <Text style={{ fontSize: FONTSIZE.H4, color: COLORS.infoDanger, textTransform: 'capitalize' }}>Belum Selesai</Text>
                                                            }
                                                        </View>
                                                    </View>
                                                </View>
                            ...
                            <View style={{ flexDirection: 'column', gap: 20, marginBottom: 20 }}>
                                <TouchableOpacity onPress={() => dispatch(postMarkKorespondensiTM({token:token, id:taskDetail.id}))}>
                                    <View style={{
                                        marginHorizontal: 20,
