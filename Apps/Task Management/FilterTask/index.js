...
export const FilterTask = ({ choiceFilter, setChoiceFilter, filterData, type }) => {
            ...
            <View style={{ flexDirection: 'row', gap: 5, justifyContent: 'flex-start', alignItems: 'center' }}>
                {
                    listFilter.map(item => (
                        ...
                        >
                            <View style={{
                                backgroundColor: choiceFilter === item.type ? COLORS.infoDangerLight : COLORS.white,
                                borderColor: choiceFilter === item.type ? COLORS.infoDangerLight : COLORS.ExtraDivinder,
                                borderRadius: 16,
                                borderWidth: 1,
                                marginVertical: 10
                            }}>
                                <Text style={{
                                    color: choiceFilter == item.type ? COLORS.primary : COLORS.grey,
                                    marginVertical: 10,
                                    marginHorizontal: 7,
