        ...
        <View style={{ width: "90%", alignSelf: "center", marginVertical: 5 }}>
            ...
            >
                ...
                <View>
                    ...
                    <View style={{ width: "80%", flexDirection: "row", justifyContent: "space-between", paddingEnd: 10, marginVertical: 10 }}>
                        <Text style={{ fontSize: 13, fontWeight: 400, color: COLORS.grey }}>Tanggal : 22 Juli 2023</Text>
                        <Text  style={{ fontSize: 13, fontWeight: 400, color: COLORS.grey }}>Nilai Saat ini : 0</Text>
                    </View>
                </View>
            </View>
        </View>
