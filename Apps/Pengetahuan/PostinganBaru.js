    ...
    <Pressable onPress={() => richText.current?.dismissKeyboard()}>
      <View style={{ flexDirection: 'row', alignItems: 'flex-end', backgroundColor: COLORS.primary, height: 80, paddingBottom: 20 }}>
        ...
        <View style={{ flex: 1, alignItems: 'center', marginRight: 50 }}>
          <Text style={{ fontSize: 15, fontWeight: 600, color: COLORS.white }}>Postingan Baru</Text>
        </View>
      </View>
      ...
      <View style={{ marginTop: 20,
          ...
          <View style={{ padding: 20, gap: 20 }}>
            ...
            <View style={{ gap: 5}}>
              <Text style={{ fontWeight: FONTWEIGHT.bold, fontSize: FONTSIZE.H3 }}>Anggota Agenda</Text>
              <View style={{
                borderWidth: 1,
                borderRadius: 4,
                borderColor: COLORS.ExtraDivinder,
            ...
            <View style={{ gap: 5}}>
              <Text style={{ fontWeight: FONTWEIGHT.bold, fontSize: FONTSIZE.H3 }}>Tempat Agenda</Text>
              <View style={{
                borderWidth: 1,
                borderRadius: 4,
                borderColor: COLORS.ExtraDivinder,
      ...
      <View style={{ marginLeft: 17, flexDirection: 'row', gap: 10, paddingBottom: 10}}>
          ...
          <TouchableOpacity style={{backgroundColor: "#752A2B", padding: 10, borderRadius: 10, width: "46.5%", height: 50, justifyContent: "center"}}>
